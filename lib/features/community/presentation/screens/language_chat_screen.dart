...
class LanguageChatScreen extends StatelessWidget {
  final String languageCode;

  const LanguageChatScreen({super.key, required this.languageCode});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _LanguageChatView(languageCode: languageCode),
    );
  }
}

class _LanguageChatView extends StatefulWidget {
  final String languageCode;

  const _LanguageChatView({required this.languageCode});

  @override
  State<_LanguageChatView> createState() => _LanguageChatViewState();
}

class _LanguageChatViewState extends State<_LanguageChatView> {
  ...
  void initState() {
    super.initState();
    MixpanelService.trackPageView('Language Chat Screen Page View', 
      additionalProps: {'language': widget.languageCode}
    );
  ...
  Widget build(BuildContext context) {
    ...
    final flag = LanguageChatScreen.languageFlags[widget.languageCode] ?? '🌐';
    final languageName = LanguageChatScreen.languageNames[widget.languageCode] ?? widget.languageCode;
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              MixpanelService.trackButtonTap('Language Chat Back Tap', 
                additionalProps: {'language': widget.languageCode}
              );
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  MixpanelService.trackButtonTap('Language Chat Telegram Banner Tap',
                                    additionalProps: {'language': widget.languageCode}
                                  );
                                  _openTelegramGroup();
                                },
                            ...
                            InkWell(
                              onTap: () {
                                MixpanelService.trackButtonTap('Language Chat Telegram Banner Close Tap',
                                  additionalProps: {'language': widget.languageCode}
                                );
                                setState(() {
