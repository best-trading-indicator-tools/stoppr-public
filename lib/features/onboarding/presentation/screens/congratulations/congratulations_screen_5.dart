...
import 'congratulations_screen_6.dart';
...
class CongratulationsScreen5 extends StatefulWidget {
  const CongratulationsScreen5({super.key});

  @override
  State<CongratulationsScreen5> createState() => _CongratulationsScreen5State();
}

class _CongratulationsScreen5State extends State<CongratulationsScreen5> {
  String? _firstName;
  ...
  void _navigateToNextScreen() {
    Navigator.of(context).pushReplacement(
      FadePageRoute(
        child: const CongratulationsScreen6(),
      ),
    );
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                // Handshake animation centered
                SizedBox(
                  height: screenSize.height * 0.4,
                  child: Lottie.asset(
                    'assets/images/lotties/Handshake.json',
                    fit: BoxFit.contain,
                    repeat: true,
                  ),
                ),
