...
import 'congratulations_screen_7.dart';
...
class CongratulationsScreen6 extends StatefulWidget {
  const CongratulationsScreen6({super.key});

  @override
  State<CongratulationsScreen6> createState() => _CongratulationsScreen6State();
}

class _CongratulationsScreen6State extends State<CongratulationsScreen6> {
  String? _firstName;
  ...
  void _navigateToNextScreen() {
    Navigator.of(context).pushReplacement(
      FadePageRoute(
        child: const CongratulationsScreen7(),
      ),
    );
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                // Centered man animation
                SizedBox(
                  height: screenSize.height * 0.4,
                  child: Lottie.asset(
                    'assets/images/lotties/Centered_man.json',
                    fit: BoxFit.contain,
                    repeat: true,
                  ),
                ),
