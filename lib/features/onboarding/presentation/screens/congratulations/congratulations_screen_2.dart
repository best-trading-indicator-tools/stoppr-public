...
import 'congratulations_screen_3.dart';
...
class CongratulationsScreen2 extends StatefulWidget {
  const CongratulationsScreen2({super.key});

  @override
  State<CongratulationsScreen2> createState() => _CongratulationsScreen2State();
}

class _CongratulationsScreen2State extends State<CongratulationsScreen2> {
  String? _firstName;
  ...
  void _navigateToNextScreen() {
    Navigator.of(context).pushReplacement(
      FadePageRoute(
        child: const CongratulationsScreen3(),
      ),
    );
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                // Growing Business animation/image centered
                SizedBox(
                  height: screenSize.height * 0.4,
                  child: Lottie.asset(
                    'assets/images/lotties/Growing Business.json',
                    fit: BoxFit.contain,
                    repeat: true,
                  ),
                ),
