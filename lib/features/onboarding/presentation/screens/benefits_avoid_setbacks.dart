...
class BenefitsAvoidSetbacksScreen extends StatefulWidget {
  const BenefitsAvoidSetbacksScreen({super.key});

  @override
  State<BenefitsAvoidSetbacksScreen> createState() => _BenefitsAvoidSetbacksScreenState();
}

class _BenefitsAvoidSetbacksScreenState extends State<BenefitsAvoidSetbacksScreen>
  ...
  void initState() {
    ...
    MixpanelService.trackPageView('Onboarding Benefits Avoid Setbacks Screen Viewed');
    ...
    // Initialize animation controller for the main lottie
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Main animation
                          Lottie.asset(
                            'assets/images/lotties/AvoidSetbacks.json',
                          ...
                          // Title
                          Text(
                            AppLocalizations.of(context)!.translate('benefitsSetbacks_title'),
                          ...
                          // Description text
                          Text(
                            AppLocalizations.of(context)!.translate('benefitsSetbacks_description'),
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              color: Colors.white,
