...
class BenefitsLevelUpLifeScreen extends StatefulWidget {
  const BenefitsLevelUpLifeScreen({super.key});

  @override
  State<BenefitsLevelUpLifeScreen> createState() => _BenefitsLevelUpLifeScreenState();
}

class _BenefitsLevelUpLifeScreenState extends State<BenefitsLevelUpLifeScreen>
  ...
  void initState() {
    ...
    MixpanelService.trackPageView('Onboarding Benefits Level Up Life Screen Viewed');
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          const SizedBox(height: 30), // Adjusted spacing at top
                          
                          // Main animation
                          Lottie.asset(
                            'assets/images/lotties/LevelUpYourLife.json',
                            controller: _animationController,
                            repeat: true,
                            height: 290, // Slightly larger
                          ...
                          const SizedBox(height: 25), // Adjusted spacing before title
                          
                          // Title
                          Text(
                            AppLocalizations.of(context)!.translate('benefitsLevelUp_title'),
                          ...
                          // Description text
                          Text(
                            AppLocalizations.of(context)!.translate('benefitsLevelUp_description'),
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              color: Colors.white,
