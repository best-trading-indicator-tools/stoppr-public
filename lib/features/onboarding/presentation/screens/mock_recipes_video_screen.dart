...
class MockRecipesVideoScreen extends StatefulWidget {
  const MockRecipesVideoScreen({super.key});

  @override
  State<MockRecipesVideoScreen> createState() => _MockRecipesVideoScreenState();
}

class _MockRecipesVideoScreenState extends State<MockRecipesVideoScreen> {
  ...
  void initState() {
    ...
    // Track page view
    MixpanelService.trackPageView('Onboarding Mock Recipes Video Screen');
  ...
  Future<void> _initializeBackgroundVideo() async {
    try {
      final controller = await VideoPlayerDefensiveService
        ...
        videoPath: 'assets/videos/mock_ob_recipes.mp4',
        isNetworkUrl: false,
        context: 'MockRecipesVideoScreen-Background',
      );
      ...
      debugPrint('MockRecipesVideoScreen: Background video init error: $e');
    }
  }
        ...
        body: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              right: 24,
              child: Text(
                l10n.translate('recipes_mockup_title'),
            ...
            // Centered looping video of the phone mockup (positioned lower for proper title spacing)
