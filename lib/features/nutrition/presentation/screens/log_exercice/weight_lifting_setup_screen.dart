...
class WeightLiftingSetupScreen extends StatefulWidget {
  const WeightLiftingSetupScreen({super.key, required this.targetDate, this.editingWorkout});
  
  final DateTime targetDate;
  final WorkoutLog? editingWorkout;

  @override
  State<WeightLiftingSetupScreen> createState() => _WeightLiftingSetupScreenState();
}

class _WeightLiftingSetupScreenState extends State<WeightLiftingSetupScreen> {
  ...
  void initState() {
    super.initState();
    MixpanelService.trackPageView('Weight Lifting Setup Screen');
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      MixpanelService.trackButtonTap('Weight Lifting Setup Screen: Back Button');
                  ...
                  Expanded(
                    child: Text(
                      l10n.translate('exerciseType_weightLifting'),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  // Intensity selector - same design as running
              ...
              child: GestureDetector(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Weight Lifting Setup Screen: Continue',
                    additionalProps: {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => CalorieBurnedResultScreen(
                        exerciseType: l10n.translate('exercise_weight_lifting'),
                        intensity: _selectedIntensity,
                        duration: _selectedDuration,
                  ...
                  child: SliderTheme(
                    ...
                    child: Slider(
                      ...
                      onChanged: (value) {
                        ...
                        MixpanelService.trackButtonTap(
                          'Weight Lifting Intensity Slider',
  ...
  Widget _buildIntensityOption(String intensity, AppLocalizations l10n) {
    ...
    // Weight lifting specific descriptions
    switch (intensity) {
      case 'high':
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    MixpanelService.trackButtonTap(
                      'Weight Lifting Duration Selection',
