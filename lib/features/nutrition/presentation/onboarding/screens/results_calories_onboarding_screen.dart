...
class ResultsCaloriesOnboardingScreen extends StatefulWidget {
  const ResultsCaloriesOnboardingScreen({
    super.key,
  ...
  @override
  State<ResultsCaloriesOnboardingScreen> createState() => _ResultsCaloriesOnboardingScreenState();
}

class _ResultsCaloriesOnboardingScreenState extends State<ResultsCaloriesOnboardingScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Continue button - navigates to RewireBenefitsScreen
              Padding(
                padding: EdgeInsets.only(
                  top: 0,
                  bottom: (MediaQuery.of(context).padding.bottom - 50).clamp(0.0, double.infinity),
                ),
