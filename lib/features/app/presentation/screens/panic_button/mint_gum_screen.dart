...
class PanicMintGumScreen extends StatefulWidget {
  const PanicMintGumScreen({super.key});

  static const String screenName = 'MintGumScreen';

  @override
  State<PanicMintGumScreen> createState() => _PanicMintGumScreenState();
}

class _PanicMintGumScreenState extends State<PanicMintGumScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Mint Gum');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Mint Gum',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicMintGum_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicMintGum_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/ChewingGum.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Mint Gum',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicMintGum_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Mint Gum Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Mint Gum InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/brush_teeth_modal_icon.png',
                    titleKey: 'panicModal_mintGum_title',
                    descriptionKey: 'panicModal_mintGum_description',
