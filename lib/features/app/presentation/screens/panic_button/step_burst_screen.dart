...
class PanicStepBurstScreen extends StatefulWidget {
  const PanicStepBurstScreen({super.key});

  static const String screenName = 'StepBurstScreen';

  @override
  State<PanicStepBurstScreen> createState() => _PanicStepBurstScreenState();
}

class _PanicStepBurstScreenState extends State<PanicStepBurstScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Step Burst');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Step Burst',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicStepBurst_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicStepBurst_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Walking.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Step Burst',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicStepBurst_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Step Burst Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Step Burst InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/exercice_modal_icon.png',
                    titleKey: 'panicModal_stepBurst_title',
                    descriptionKey: 'panicModal_stepBurst_description',
