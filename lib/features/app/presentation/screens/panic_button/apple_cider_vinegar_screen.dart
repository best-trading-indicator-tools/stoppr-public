...
class PanicAppleVinegarScreen extends StatefulWidget {
  const PanicAppleVinegarScreen({super.key});

  static const String screenName = 'AppleVinegarScreen';

  @override
  State<PanicAppleVinegarScreen> createState() => _PanicAppleVinegarScreenState();
}

class _PanicAppleVinegarScreenState extends State<PanicAppleVinegarScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Apple Vinegar');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Apple Vinegar',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicAppleVinegar_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicAppleVinegar_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Applevinegar.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Apple Vinegar',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicAppleVinegar_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Apple Vinegar Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Apple Vinegar InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/water_modal_icon.png',
                    titleKey: 'panicModal_appleVinegar_title',
                    descriptionKey: 'panicModal_appleVinegar_description',
