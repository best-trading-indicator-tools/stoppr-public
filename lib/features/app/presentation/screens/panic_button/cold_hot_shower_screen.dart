...
class PanicColdHotShowerScreen extends StatefulWidget {
  const PanicColdHotShowerScreen({super.key});

  static const String screenName = 'ColdHotShowerScreen';

  @override
  State<PanicColdHotShowerScreen> createState() => _PanicColdHotShowerScreenState();
}

class _PanicColdHotShowerScreenState extends State<PanicColdHotShowerScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Cold Hot Shower');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Cold Hot Shower',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicColdHotShower_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicColdHotShower_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/ShowerBath.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Cold Hot Shower',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicColdHotShower_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Cold Hot Shower Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Cold Hot Shower InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/water_modal_icon.png',
                    titleKey: 'panicModal_coldHotShower_title',
                    descriptionKey: 'panicModal_coldHotShower_description',
