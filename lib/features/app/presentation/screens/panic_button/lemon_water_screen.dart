...
class PanicLemonWaterScreen extends StatefulWidget {
  const PanicLemonWaterScreen({super.key});

  static const String screenName = 'LemonWaterScreen';

  @override
  State<PanicLemonWaterScreen> createState() => _PanicLemonWaterScreenState();
}

class _PanicLemonWaterScreenState extends State<PanicLemonWaterScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Lemon Water');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Lemon Water',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicLemonWater_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicLemonWater_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Lemonade.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Lemon Water',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicLemonWater_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Lemon Water Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Lemon Water InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/water_modal_icon.png',
                    titleKey: 'panicModal_lemonWater_title',
                    descriptionKey: 'panicModal_lemonWater_description',
