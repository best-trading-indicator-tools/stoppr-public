...
class PanicColdSparklingWaterScreen extends StatefulWidget {
  const PanicColdSparklingWaterScreen({super.key});

  static const String screenName = 'ColdSparklingWaterScreen';

  @override
  State<PanicColdSparklingWaterScreen> createState() => _PanicColdSparklingWaterScreenState();
}

class _PanicColdSparklingWaterScreenState extends State<PanicColdSparklingWaterScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Cold Sparkling Water');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Cold Sparkling Water',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicColdSparklingWater_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicColdSparklingWater_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/ColdSparklingWater.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Cold Sparkling Water',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicColdSparklingWater_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Cold Sparkling Water Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Cold Sparkling Water InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/water_modal_icon.png',
                    titleKey: 'panicModal_coldSparklingWater_title',
                    descriptionKey: 'panicModal_coldSparklingWater_description',
