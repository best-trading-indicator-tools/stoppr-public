...
class PanicFruitsFiberScreen extends StatefulWidget {
  const PanicFruitsFiberScreen({super.key});

  static const String screenName = 'FruitsFiberScreen';

  @override
  State<PanicFruitsFiberScreen> createState() => _PanicFruitsFiberScreenState();
}

class _PanicFruitsFiberScreenState extends State<PanicFruitsFiberScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Fruits Fiber');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Fruits Fiber',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicFruitsFiber_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicFruitsFiber_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Fruits.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Fruits Fiber',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicFruitsFiber_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Fruits Fiber Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Fruits Fiber InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/avocado_icon.png',
                    titleKey: 'panicModal_fruitsFiber_title',
                    descriptionKey: 'panicModal_fruitsFiber_description',
