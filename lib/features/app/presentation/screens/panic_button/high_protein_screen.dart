...
class PanicHighProteinScreen extends StatefulWidget {
  const PanicHighProteinScreen({super.key});

  static const String screenName = 'HighProteinScreen';

  @override
  State<PanicHighProteinScreen> createState() => _PanicHighProteinScreenState();
}

class _PanicHighProteinScreenState extends State<PanicHighProteinScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button High Protein');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button High Protein',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicHighProtein_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicHighProtein_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Protein.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button High Protein',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicHighProtein_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button High Protein Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button High Protein InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/eggs_icon.png',
                    titleKey: 'panicModal_highProtein_title',
                    descriptionKey: 'panicModal_highProtein_description',
