...
class PanicVisualizationScriptScreen extends StatefulWidget {
  const PanicVisualizationScriptScreen({super.key});

  static const String screenName = 'VisualizationScriptScreen';

  @override
  State<PanicVisualizationScriptScreen> createState() => _PanicVisualizationScriptScreenState();
}

class _PanicVisualizationScriptScreenState extends State<PanicVisualizationScriptScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Visualization Script');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Visualization Script',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicVisualizationScript_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicVisualizationScript_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Visualization.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Visualization Script',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicVisualizationScript_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Visualization Script Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Visualization Script InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/svg/attractiveness_icon.svg',
                    titleKey: 'panicModal_visualizationScript_title',
                    descriptionKey: 'panicModal_visualizationScript_description',
