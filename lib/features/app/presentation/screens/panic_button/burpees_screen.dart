...
class PanicBurpeesScreen extends StatefulWidget {
  const PanicBurpeesScreen({super.key});

  static const String screenName = 'BurpeesScreen';

  @override
  State<PanicBurpeesScreen> createState() => _PanicBurpeesScreenState();
}

class _PanicBurpeesScreenState extends State<PanicBurpeesScreen> {
  @override
  void initState() {
    super.initState();
    MixpanelService.trackPageView('PageView: Panic Button Burpees');
  }
          ...
          children: [
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Close Panic Button Burpees',
                  );
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicBurpees_title'),
                ...
                Padding(
                  ...
                  child: Text(
                    l10n.translate('panicBurpees_subtitle'),
                    textAlign: TextAlign.center,
                    style: const TextStyle(
                      fontFamily: 'ElzaRound',
                      fontSize: 16,
                ...
                Expanded(
                  child: Lottie.asset(
                    'assets/images/lotties/panicButton/Burpees.json',
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            MixpanelService.trackButtonTap(
                              'Button Tap: Panic Button Burpees',
                            );
                          ...
                          child: Text(
                            l10n.translate('panicBurpees_button_didIt'),
                            style: const TextStyle(
                              fontFamily: 'ElzaRound',
                              fontSize: 19,
                      ...
                      TextButton(
                        onPressed: () {
                          MixpanelService.trackButtonTap(
                            'Button Tap: Panic Button Burpees Feeling Better',
                          );
                          Navigator.of(context).pushReplacement(
                            MaterialPageRoute(
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  MixpanelService.trackButtonTap(
                    'Button Tap: Panic Button Burpees InfoModal',
                  );
                  showInfoModalBottomSheet(
                    context: context,
                    imageAssetPath: 'assets/images/panic_button/exercice_modal_icon.png',
                    titleKey: 'panicModal_burpees_title',
                    descriptionKey: 'panicModal_burpees_description',
